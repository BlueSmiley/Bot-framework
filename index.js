...
// Import middleware reponsible for translating user's messages
...
let bot;
try {
    bot = new MyBot(luisApplication, luisPredictionOptions, conversationState, userState);
} catch (err) {
